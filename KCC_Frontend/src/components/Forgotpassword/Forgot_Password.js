...
import { authForgotPassword } from "../../Reducers/Auth";
import {
  Mail,
  ArrowRight,
  ArrowLeft,
    ...
    dispatch(authForgotPassword(data))
      .then((action) => {
        ...
        if (action.payload.success) {
          ...
          alert("Error sending email: " + action.payload.message);
          toast.current.show({
            severity: "error",
    ...
    <div className="min-h-screen w-full flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <div
            className={`absolute bottom-20 right-16 w-64 h-64 rounded-full opacity-15 animate-float-slow
          ...
          />
          <div className="absolute top-24 right-20 opacity-10 animate-float-slow animation-delay-200">
            <KeyRound size={100} strokeWidth={1} className="text-green-300" />
          </div>
          <div className="absolute bottom-40 left-16 opacity-10 animate-float animation-delay-500">
        ...
        >
          ...
          {emailSent ? (
            <div className="text-center animate-fade-in-up">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-3 mb-8">
              ...
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-sm font-semibold text-green-600 hover:text-green-700 transition-colors duration-200 hover:underline underline-offset-4"
              >
                <ArrowLeft size={16} />
                Back to Sign In
              </Link>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  ...
                  <div className="relative group">
                    <div
                      className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors duration-300 ${focusedField === "email"
                        ? "text-green-600"
                        : "text-gray-400"
                        }`}
                    >
                ...
                {/* Divider */}
                <div
                  className={`flex items-center gap-4 transition-all duration-700 delay-[350ms] ${mounted ? "opacity-100" : "opacity-0"
                    }`}
                >
                ...
                {/* Back to Login */}
                <div
                  className={`text-center transition-all duration-700 delay-[400ms] ${mounted
                    ? "opacity-100 translate-y-0"
